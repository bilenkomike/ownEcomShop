...
export const LoginStyledForm = styled.form`
  ...
  position: relative;
`;
export const LoginStyledCloseButton = styled.button`
  position: absolute;
  top: 24px;
  right: 24px;
...
export const LoginStyledForgotPassword = styled.div`
  display: flex;
  justify-content: space-between;
`;

export const LoginStyledTitle = styled.h3`
  text-align: center;
  font-weight: 700;
  font-size: 28px;
...
export const LoginStyledSubTitle = styled.h3`
  text-align: center;
  font-weight: 400;
  font-size: 14px;
  color: ${Colors.gray700};
...
export const LoginStyledSocials = styled.div`
  display: flex;
  margin-top: 20px;
  justify-content: center;
